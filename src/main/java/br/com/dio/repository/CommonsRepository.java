...
public final class CommonsRepository {
    ...
    public static void checkFundsForTransaction(final Wallet source, final long amount){
        if (source.getFunds() < amount) {
            throw new NoFundsEnoughException("Sua conta não possui saldo suficiente para realizar essa transação.");
        }
    }

    public static List<Money> genereteMoney(final UUID transactionId, final long funds, final String description) {
